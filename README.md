...
<div align="center"> <img src="./main/assets/project_banner.png" alt="TOP Project Banner" width="100%" /> </div>
...
⛰️ **지금 바로 여러분의 아이디어와 열정을 펼쳐보세요!**  
**최고의 프로젝트를 최고의 사람들과 함께 TOP에서 시작해보세요.**
...
### 이후 방향
- HTTPS 도입으로 보안에 관련된 기능을 향상시키고 네트워크 보안에 대한 학습을 진행한다 (완료)
